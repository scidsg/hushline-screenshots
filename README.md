...
- Release key: `v0.5.123`
- Base URL: `http://localhost:8080`
- Path: [releases/v0.5.123/README.md](./releases/v0.5.123/README.md)
...
```sh
make docs-screenshots RELEASE=v0.5.123
make docs-screenshots-first-user RELEASE=v0.5.123
```
