# Screenshot Set: v0.7.24

Captured: 2026-08-23T18:05:02.947Z

| Scene | Path | Session | Viewport | Theme | Mode | File |
| --- | --- | --- | --- | --- | --- | --- |
| Inbox - artvandelay conversations | `/inbox?type=conversations` | artvandelay | desktop | light | fold | ![auth-artvandelay-inbox-conversations-desktop-light-fold](./artvandelay/auth-artvandelay-inbox-conversations-desktop-light-fold.png) |
| Conversation thread - artvandelay | `/conversation/33333333-3333-4333-8333-333333333333` | artvandelay | desktop | light | fold | ![auth-artvandelay-conversation-thread-desktop-light-fold](./artvandelay/auth-artvandelay-conversation-thread-desktop-light-fold.png) |
| Conversation thread - artvandelay | `/conversation/33333333-3333-4333-8333-333333333333` | artvandelay | mobile | light | fold | ![auth-artvandelay-conversation-thread-mobile-light-fold](./artvandelay/auth-artvandelay-conversation-thread-mobile-light-fold.png) |
| Tools - Email Validation status: appears valid (artvandelay) | `/email-headers` | artvandelay | desktop | light | fold | ![auth-artvandelay-tools-email-validation-status-valid-desktop-light-fold](./artvandelay/auth-artvandelay-tools-email-validation-status-valid-desktop-light-fold.png) |
